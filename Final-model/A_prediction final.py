...
class Application:
    ...
    def __init__(self):
        ...
        self.model = load_model('finalmodel.h5')
        ...
        self.panel = tk.Label(self.root, bg="white", relief="flat", borderwidth=0)
        self.panel.place(x=100, y=80, width=480, height=450)
        self.panel.config(highlightbackground="#c7d1e3", highlightthickness=2)

        self.panel2 = tk.Label(self.root, bg="white", relief="flat", borderwidth=0)
        self.panel2.place(x=700, y=80, width=400, height=400)
        self.panel2.config(highlightbackground="#c7d1e3", highlightthickness=2)

        self.T = tk.Label(self.root, text="Sign Language To Text Conversion", 
                          font=("Segoe UI", 28, "bold"), bg="#000000", fg="#ffffff")
        self.T.place(x=300, y=5)

        self.panel3 = tk.Label(self.root, bg="white", relief="flat", font=("Segoe UI", 20), fg="#212121")
        self.panel3.place(x=260, y=585)
        self.panel3.config(highlightbackground="#c7d1e3", highlightthickness=1)

        self.T1 = tk.Label(self.root, text="Character:", font=("Segoe UI", 20, "bold"), bg="#000000", fg="#ffffff")
        self.T1.place(x=10, y=580)

        self.panel5 = tk.Label(self.root, bg="white", relief="flat", font=("Segoe UI", 18), fg="#212121")
        self.panel5.place(x=260, y=632, width=800, height=40)
        self.panel5.config(highlightbackground="#c7d1e3", highlightthickness=1)

        self.T3 = tk.Label(self.root, text="Sentence:", font=("Segoe UI", 20, "bold"), bg="#000000", fg="#ffffff")
        self.T3.place(x=10, y=632)

        self.clear = tk.Button(self.root, text="Clear", font=("Segoe UI", 16), bg="#4CAF50", fg="white", 
                                activebackground="#45a049", activeforeground="white", relief="flat", 
                                command=self.clear_fun)
        self.clear.place(x=1205, y=630, width=80, height=40)
        self.clear.config(borderwidth=0, highlightthickness=0)
    ...
    def video_loop(self):
        try:
            ...
            if hands:
                ...
                white = cv2.imread("C:\\Users\\wissa\\Desktop\\Seminar Official\\Final-model\\white.jpg")
